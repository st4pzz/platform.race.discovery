...
## Descrição
Este projeto é parte de uma plataforma de serviço de descoberta em uma arquitetura de microserviços. Ele foi desenvolvido com foco em escalabilidade, flexibilidade e facilidade de manutenção.
...
1. Clone o repositório:
    ```bash
    git clone https://github.com/st4pzz/platform.race.discovery.git
    cd platform.race.discovery
    ```
